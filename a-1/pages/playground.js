          ...
          <Link href={'./aboutme'}> <b className='flex w-40 h-16 bg-red-300 hover:bg-yellow-300 flex items-center justify-center'>
           ...
           <a className='pt-8 pb-8 flex items-center justify-center hover:scale-105 ease-in duration-300 '> <div onClick={discon}>
            ...
            <a className='pt-8 pb-8 flex items-center justify-end pr-8 hover:scale-105 ease-in duration-300  '> 
              <b className='flex w-40 h-16 bg-red-300 hover:bg-yellow-300 flex items-center justify-center'> <a className='flex font-semibold cursor-pointer hover:text-red-500 text-xl'> <CMGSLESS/></a></b>
                 </a>
            </r>
