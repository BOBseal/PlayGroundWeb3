...
function MobileNav({open, setOpen}) {
    return (
        <div className={`absolute top-0 left-0 h-screen w-screen bg-white transform ${open ? "-translate-y-0" : "-translate-y-full"} transition-transform duration-300 ease-in-out filter  `}>
            ...
            <Link  href= './Pages/hm'> <div className='text-2xl font-bold text-red-500 my-4 hover:scale-105 ease-in duration-300 hover:text-yellow-400'>  HOME </div> </Link>
                <Link  href= './Pages/playground' > <div className='text-2xl font-bold text-red-500 my-4 hover:scale-105 ease-in duration-300 hover:text-yellow-400'>  PLAYGROUND </div> </Link>
